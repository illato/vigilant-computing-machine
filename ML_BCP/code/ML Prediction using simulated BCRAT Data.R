...
my.ada <- function (train.x, train.y, test.x, test.y, negative, formula){
  ...
  return (out)
  return (predict.y)
  # Someone correct me if I am wrong, but the original author's second 
  # return statement will never be hit--IIRC
}
...
# 0.502083333 0.430034130 0.570846906 0.488845781 0.512052593 0.003595433 
...
# acc        sens        spec         ppv         npv         lor 
# 0.49625000  0.49573379  0.49674267  0.48457048  0.50791007 -0.03009476 
...
#
# The original author already defined this exact function above.
#
...
#22.45
#
# Not sure what the original author meant by COR being 22.45, as: 0 < cor() < 1
...
# Stopping here for now, as: 
#
# acc sens spec  ppv  npv  lor 
# NA   NA   NA   NA   NA   NA 
#
# Whereas the original author has NaN above, which looks like Python output.
#
# Additionally, ML in R is outside the scope of orange3-conformal in Python
